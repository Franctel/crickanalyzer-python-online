...
(function () {
    ...
    loadScriptIfElementsExist("[data-toast]", '../static/libs/toastify-js/src/toastify.js');
    loadScriptIfElementsExist("[data-provider]", '../static/libs/flatpickr/flatpickr.min.js');
